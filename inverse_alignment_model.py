...
class InverseCEA(flair.nn.Classifier[Sentence]):
    def __init__(
        self,
        ...
        **classifierargs,
        ...
        """
        Inverse Model: find a sample (or multiple samples) from a different class and push them close
        ...
        super(InverseCEA, self).__init__(**classifierargs)
    ...
    def forward_loss(self, sentences: List[Sentence]) -> Tuple[torch.Tensor, int]:
        ...
        for sentence in sentences:
            ...
            # Inverse model:
            # Find a negative sample (or multiple negatives if use_all_negatives=True)
            # and push them close (cos sim of 1 means same angle)
